...
class NameListTests(TestCase):
    def create_and_assert(self, model, name, expected_error=None):
        ...
        :param model: The model class (e.g., DrugName, ReactionName), inheriting from TermName.
    ...
    def test_create_objects(self):
        """Test creating both DrugName and ReactionName objects."""
...
class ResultModelTests(TestCase):
    ...
    def test_result_str_representation(self):
        result = Result.objects.create(query=self.query, status=ResultStatus.COMPLETED)
